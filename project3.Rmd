...
abs_train <- abs_rand[1:640, ]
abs_test  <- abs_rand[641:740, ]

# check the proportion of class variable
prop.table(table(abs_train$timecat))
prop.table(table(abs_test$timecat))

## Step 3: Training a model on the data ----
# build the simplest decision tree
library(C50)
abs_model <- C5.0(abs_train[-20], abs_train$timecat)
...
abs_boost10 <- C5.0(abs_train[-20], abs_train$timecat,
                       trials = 10)
abs_boost10
summary(abs_boost10)
...
abs_boost100 <- C5.0(abs_train[-20], abs_train$timecat,
                        trials = 100)
...
abs_cost <- C5.0(abs_train[-210], abs_train$timecat,
                          costs = error_cost)
