...
library(C50)
abs_model <- C5.0(abs_train_tree[-16], abs_train_tree$timecat)
...
abs_boost10 <- C5.0(abs_train_tree[-16], abs_train_tree$timecat,
                       trials = 10)
abs_boost10
summary(abs_boost10)
plot(abs_boost10)
...
abs_boost100 <- C5.0(abs_train_tree[-16], abs_train_tree$timecat,
                        trials = 100)
...
abs_cost <- C5.0(abs_train_tree[-16], abs_train_tree$timecat,
                          costs = error_cost)
